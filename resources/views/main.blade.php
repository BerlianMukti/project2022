    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#gallery">Daftar Pesanan</a></li>
          <li><a class="nav-link scrollto" href="#contact">Kontak</a></li>
           <li><a class="nav-link scrollto" href="#gallery">Masuk</a></li>
            <li><a class="nav-link scrollto" href="#gallery">Daftar</a></li>
        </ul>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Bersama POJ Cah</h1>
            <h1>Jatim Aman</h1>
            <h1><span>Nikahane</span></h1>
            <h2>POJ adalah penyedia jasa wedding dan prewedding yang ada di kota malang jawa timur</h2>
            <div class="text-center text-lg-start">
              <a href="#about" class="btn-get-started scrollto">Temukan Layanan</a>
            </div>
          </div>
        </div>
